...
// Create custom icons for different incident types - Simplified for better rendering
const createCustomIcon = (severity: string) => {
  ...
  return L.divIcon({
    html: `<div class="custom-incident-marker" style="
...
const createUserLocationIcon = () => {
  return L.divIcon({
    html: `<div style="background-color: #3b82f6; width: 16px; height: 16px; border-radius: 50%; border: 3px solid white; box-shadow: 0 2px 8px rgba(59, 130, 246, 0.4); animation: locationPulse 2s infinite;"></div>`,
    className: "",
    iconSize: [22, 22],
    iconAnchor: [11, 11],
  });
...
const MapDemo: React.FC = () => {
  ...
  return (
    <div className="w-full h-full min-h-[400px] relative bg-gray-100 rounded-lg overflow-hidden border border-gray-300">
      ...
      <MapContainer
        center={[-12.086, -77.04]} // Centro ajustado para mejor vista de Lima
        zoom={11} // Zoom reducido para ver mejor distribución
      ...
      >
        ...
        {viewMode === "incidents" &&
          limaIncidents.map((incident, index) => {
            const position = [incident.lat, incident.lng] as [number, number];
                ...
                <Popup>
                  <div className="p-2">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      <strong>Coords:</strong> {incident.lat}, {incident.lng}
                    </p>
                  </div>
                </Popup>
              </Marker>
